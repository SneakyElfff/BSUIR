...
//  Lab05
//
//  Created by Нина Альхимович on 01.06.23.
//
...
int main(int argc, const char *argv[])
{
    ...
    void killAny(pthread_t *, int *, int);
    ...
    while(1)
    {
        switch(getchar())
        {
            case 'c':
                ...
                printf("Процесс-производитель %ld создан\n", pthread);
            ...
            case '+':
                ...
                printf("Процесс-потребитель %ld создан\n", pthread);
...
void killAny(pthread_t *children, int *counter, int num)
{
    pthread_t pthread;
    int child_status;
